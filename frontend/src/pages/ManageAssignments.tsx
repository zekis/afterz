...
import { UserPlus, Search, Folder, Users, AlertCircle } from 'lucide-react'
import { PageHeader, ContentLayout } from '../components/Layout'
    ...
    return (
      <div className="h-full flex flex-col">
        <PageHeader
          ...
          description="Assign activities to team members and manage project assignments"
        />
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <PageHeader
        ...
        description="💡 You can only see projects where you are the project lead or timesheet approver. Only open activities (not closed or cancelled) can be assigned."
      />
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-1/2 border-r flex flex-col bg-white">
          <div className="p-6 border-b bg-gray-50">
            <h3 className="font-medium text-gray-900 mb-4">Select Activity to Assign</h3>
