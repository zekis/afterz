...
import { X, Edit3, User, Tag, AlertCircle } from 'lucide-react'
import { TodoLite, Project, User as UserType, ExtendedTodo } from '../../types'
...
interface EditTodoModalProps {
  ...
  onUpdateTodo: (todoName: string, updates: Partial<TodoLite>) => Promise<void>
}
  ...
  useEffect(() => {
    if (isOpen && todo) {
      ...
      setFormData({
        ...
        description: '' // Note: description is not available in TodoLite/ExtendedTodo
      })
      setError(null)
    }
  }, [isOpen, todo])
