...
import { Activity, Project, TimesheetEntry, CalendarEvent } from '../../types'
...
const DailyCalendar: React.FC<DailyCalendarProps> = ({
  ...
  const positionedEvents = useMemo(() => {
    return events
      ...
      .filter(event => event.isVisible) as (CalendarEvent & { topPosition: number; height: number; isVisible: boolean })[]
